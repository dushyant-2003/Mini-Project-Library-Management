	...
	void testReturnBook_WithFine() {
	 ...
	 @Test
	    void testIssueBook_NotIssuedWhenBookIssueLimitIsZero() {
	        ...
	        // No need to mock bookDAO or userDAO interactions since the user should not be allowed to issue a book
	        ...
	        // Verify that no interactions happened with bookDAO or userDAO for issuing the book
